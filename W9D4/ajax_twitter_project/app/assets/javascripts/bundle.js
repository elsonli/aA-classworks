...
class FollowToggle {
  ...
  handleClick(event) {
    ...
    if (this.followState === "unfollowed") {
      ...
      this.render();
      _api_util_js__WEBPACK_IMPORTED_MODULE_0__["default"].followUser(this.userId)
        .then(() => {
      ...
      this.followState = 'PENDING';
      this.render();
      _api_util_js__WEBPACK_IMPORTED_MODULE_0__["default"].unfollowUser(this.userId)
        .then(() => {
...
$(() => {
  $("button.follow-toggle").each((idx, button) => new _follow_toggle__WEBPACK_IMPORTED_MODULE_0__["default"](button));
});
